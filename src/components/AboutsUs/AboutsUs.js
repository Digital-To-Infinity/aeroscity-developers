...
const AboutsUs = () => {
  ...
  return (
    <div className="about-us-wrapper" ref={containerRef}>
      ...
      {/* --- SECTION 2: The Philosophy Reveal (Creative Animation) --- */}
      ...
      {/* --- SECTION 3: 3D Core Values (Animated Cards) --- */}
      ...
      {/* --- SECTION 4: The Blueprint (Sticky Scroll) --- */}
        ...
        <div className="container blueprint-flex">
          ...
          <div className="blueprint-steps">
            <BlueprintStep 
              number="01" 
              title="Acquisition" 
              desc="Identifying high-potential land parcels before the market catches up."
            />
            <BlueprintStep 
              number="02" 
              title="Legal Clearance" 
              desc="Rigorous due diligence, 7/12 extract verification, and TP sanctioning."
            />
            <BlueprintStep 
              number="03" 
              title="Development" 
              desc="Leveling, demarcation, and infrastructure setup (Roads, Water, Electricity)."
            />
            <BlueprintStep 
              number="04" 
              title="Handover" 
              desc="Immediate possession with complete ownership documents and seamless registration."
            />
          </div>
